      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none -translate-y-full">
        ...
        >
          ...
          <path
            ...
            className="fill-[url(#footer-gradient)]"
          />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-3">
          <div className="lg:col-span-1">
            ...
            <p className="text-white text-xs sm:text-sm md:text-base leading-relaxed mb-6">
              Dreamlytix is a leading school management software company in India.
              We build secure school websites, admin panels, student management
              systems, and mobile applications to help educational institutions
...
function FooterLink({
  ...
  return (
    <li>
      <Link
        href={href}
        className="text-white text-sm transition-all duration-300 hover:translate-x-1 inline-block relative group hover:text-yellow-300"
      >
        {label}
