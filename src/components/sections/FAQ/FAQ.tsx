...
// Kept the original questions but we'll render in the requested style
const faqs = [
  {
    ...
    <section className="relative py-24 bg-[#f4f5f6]" id="faq">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-20 items-start">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-slate-900 leading-[1.15]">
              Frequently Asked
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  <div
                    className="bg-white rounded-[10px] shadow-[0_2px_8px_rgba(0,0,0,0.02)] border border-[#eaeaea] overflow-hidden transition-all duration-300 hover:shadow-[0_4px_16px_rgba(0,0,0,0.04)]"
                  >
                    <button
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <span className="text-[15px] sm:text-[16px] font-medium text-slate-800 pr-4 leading-tight">
                          {faq.question}
                        </span>
                      </div>

                      <motion.div animate={{ rotate: isOpen ? 180 : 0 }} transition={{ duration: 0.3 }} className="shrink-0 flex items-center">
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen && (
                        ...
                        >
                          <div className="px-5 md:px-6 pb-5 md:pb-6 pt-0 text-slate-600 leading-relaxed text-sm md:text-[15px] pl-[34px] md:pl-[44px]">
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
