        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <m.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
              ...
              <span className="bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-500 bg-clip-text text-transparent">Digital Future</span> of Education
            </h2>
            ...
            <p className="text-gray-500 text-base leading-relaxed mb-8">
              Founded with a vision to empower schools and educational organizations, we have evolved into India&apos;s premier ed-tech development agency. From a
              passionate team of developers to a full-fledged agency, our journey has been driven by one simple goal: to make technology intuitive and highly impactful
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-white rounded-3xl p-6 shadow-xl shadow-blue-900/5 border border-gray-100 h-64 relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Custom Built</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((val, idx) => (
            ...
            >
              ...
              <div
                className={`relative w-14 h-14 rounded-2xl bg-linear-to-br ${val.gradient} flex items-center justify-center shadow-lg shadow-blue-500/20 mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
