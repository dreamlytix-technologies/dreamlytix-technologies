...
const values = [
  {
    icon: Target,
    title: "Our Mission",
    desc: "To make business management simple, scalable, and impactful by delivering high-performing digital products.",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: ShieldCheck,
    title: "Unwavering Trust",
    desc: "Building secure, reliable ecosystems so organizations can focus on what matters most—delivering impact.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6 font-medium">
              At Dreamlytix, we believe technology isn&apos;t just about
              code—it&apos;s about creating possibilities, building trust, and
              driving institutional growth.
            </p>

            <p className="text-gray-500 text-base leading-relaxed mb-8">
              Founded with a vision to empower businesses and organizations, we
              have evolved into India&apos;s premier software development
              agency. From a passionate team of developers to a full-fledged
              agency, our journey has been driven by one simple goal: to make
              technology intuitive and highly impactful for learning
              environments.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-white rounded-3xl p-6 shadow-xl shadow-blue-900/5 border border-gray-100 h-64 relative overflow-hidden group">
                  ...
                  <p className="text-sm text-gray-500">
                    Tailor-made portals and systems designed exclusively for
                    your institution&apos;s workflow.
                  </p>
                </div>
                <div className="bg-linear-to-br from-blue-600 to-cyan-600 rounded-3xl p-6 shadow-xl shadow-cyan-900/20 text-white h-48 relative overflow-hidden">
                  ...
                  <p className="text-cyan-100 font-medium leading-tight">
                    Commitment to delivering scalable results.
                  </p>
                </div>
              </div>
              <div className="space-y-4 pt-10">
                <div className="bg-gray-900 rounded-3xl p-6 shadow-xl shadow-gray-900/20 text-white h-48 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold mb-2">Prebuilt & Secure</h3>
                  <p className="text-sm text-gray-400">
                    Fast, affordable, and incredibly secure deployments.
                  </p>
                </div>
                <div className="bg-white rounded-3xl p-6 shadow-xl shadow-emerald-900/5 border border-gray-100 h-64 relative overflow-hidden group">
                  ...
                  <p className="text-sm text-gray-500">
                    A passionate squad of developers turning your vision into a
                    digital reality.
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((val, idx) => (
            <m.div
              ...
              className="bg-white rounded-3xl px-5 py-6 border border-gray-100 shadow-xl shadow-gray-200/40 hover:-translate-y-2 transition-transform duration-300 group relative overflow-hidden"
            >
              <div
                className={`absolute top-0 left-0 w-full h-1 bg-linear-to-r opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${val.gradient}`}
              />
              ...
              <div
                className={`relative w-10 h-10 rounded-2xl bg-linear-to-br ${val.gradient} flex items-center justify-center shadow-lg shadow-blue-500/20 mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
              ...
              <p className="relative text-gray-500 text-sm font-semibold">
                {val.desc}
              </p>
            </m.div>
          ))}
